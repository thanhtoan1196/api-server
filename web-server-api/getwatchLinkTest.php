...
if($video == '') {
	...
	} else if (strpos($video, 'vidnode.net') !== false || strpos($video, 'vidcloud.icu') !== false || strpos($video, 'vidcloud9') !== false) {
...
// 			echo get_redirect_target($movie);
	...
	} else if (strpos($video, 'openload') !== false || strpos($video, 'streamango') !== false) {
		// getMovies($video);
		// echo $video;
		echo "http://film.mp4";
...
// 		$video = str_replace('https://', 'http://', $video);
		...
		if (strpos($video, 'https://www.rapidvideo.com/e/') !== false) {
			...
			$video = $video . "----------" . "a-45-href-mp4|a-46-href-mp4|a-47-href-mp4|a-48-href-mp4|a-49-href-mp4|a-50-href-mp4|a-51-href-mp4|a-52-href-mp4|a-53-href-mp4|a-54-href-mp4|a-55-href-mp4";
		}
		echo $video;
	}
}
